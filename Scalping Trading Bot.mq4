...
#property copyright "SALWAN TRADERS "
#D
#property version   "7.0"
#property strict

static input string _Properties_ = "------"; // --- Expert Properties ---
static input int    Magic_Number = 1160204935; // Magic number
static input double Entry_Amount =     0.26; // Entry lots
       input int    Stop_Loss    =    44739; // Stop Loss   (pips)
       input int    Take_Profit  =    90321; // Take Profit (pips)

static input string ___0______   = "------"; // --- RSI ---
       input int    Ind0Param0   =       15; // Period
       input int    Ind0Param1   =       75; // Level

static input string ___1______   = "------"; // --- Alligator ---
       input int    Ind1Param0   =       20; // Jaws period
       input int    Ind1Param1   =        6; // Jaws shift
       input int    Ind1Param2   =        6; // Teeth period
       input int    Ind1Param3   =        3; // Teeth shift
       input int    Ind1Param4   =        3; // Lips period
       input int    Ind1Param5   =        2; // Lips shift

static input string ___2______   = "------"; // --- Alligator ---
       input int    Ind2Param0   =       25; // Jaws period
       input int    Ind2Param1   =       18; // Jaws shift
       input int    Ind2Param2   =       18; // Teeth period
       input int    Ind2Param3   =       11; // Teeth shift
       input int    Ind2Param4   =       11; // Lips period
       input int    Ind2Param5   =        2; // Lips shift 
...
int GetEntrySignal(void)
  {
   // RSI (Close, 15), Level: 75
   double ind0val1  = iRSI(NULL, 0, Ind0Param0, PRICE_CLOSE, 1);
   double ind0val2  = iRSI(NULL, 0, Ind0Param0, PRICE_CLOSE, 2);
...
void ManageClose(void)
  {
   // Alligator (Smoothed, Median, 20, 6, 6, 3, 3, 2)
   double ind1val1  = iAlligator(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, Ind1Param3, Ind1Param4, Ind1Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORTEETH, 1);
   double ind1val2  = iAlligator(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, Ind1Param3, Ind1Param4, Ind1Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   1);
   double ind1val3  = iAlligator(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, Ind1Param3, Ind1Param4, Ind1Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORTEETH, 2);
   double ind1val4  = iAlligator(NULL, 0, Ind1Param0, Ind1Param1, Ind1Param2, Ind1Param3, Ind1Param4, Ind1Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   2);
   ...
   // Alligator (Smoothed, Median, 25, 18, 18, 11, 11, 2)
   double ind2val1  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORLIPS,  1);
   double ind2val2  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   1);
   double ind2val3  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORLIPS,  2);
   double ind2val4  = iAlligator(NULL, 0, Ind2Param0, Ind2Param1, Ind2Param2, Ind2Param3, Ind2Param4, Ind2Param5, MODE_SMMA, PRICE_MEDIAN, MODE_GATORJAW,   2);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Eightcap; BTCUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.26,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":44739,"takeProfit":90321,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"RSI","listIndexes":[5,3,0,0,0],"numValues":[15,75,0,0,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[11,3,4,0,0],"numValues":[20,6,6,3,3,2]},{"name":"Alligator","listIndexes":[9,3,4,0,0],"numValues":[25,18,18,11,11,2]}]} */
